...
?>
<h2 align='center'> Додај нов Администратор </h2>

<?php 
echo form_open(base_url().'admin/addAdmin');
?>
<table align='center' width='500px'> 
        ...
        <tr> <td> Населено место </td> <td align='center'> <input type='text' pattern="[a-zA-Zа-шА-Ш]{3,}" name='mesto'> </td> </tr>
        <tr> <td> </td> 
                        <td align='center'> 
